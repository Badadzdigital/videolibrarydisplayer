...
function buildLibrary() {
    ...
    for(i=x;i<=y;i++) {
        ...
        library.innerHTML += "<div id='vid"+i+"' class='video-card' style='background-image: url(&quot;"+videoImg+"&quot;); background-size: contain; background-repeat: no-repeat;' draggable='false'><div class='nameBox'><p class='text'>"+videoName+"</p></div></div>";
